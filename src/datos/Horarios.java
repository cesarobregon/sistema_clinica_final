...
public class Horarios extends Conexion{
     ...
     * la base de datos en la tabla horarios
     *
     * @param o
    ...
    /**
     * Metodo que recibe como parametro un Objeto tipo Horario y lo ACTUALIZA en
     * la base de datos en la tabla horarios
     *
     * @param o
     * @return true=registra, false=presencia de error
    ...
    /**
     * Metodo que recibe como parametro un Objeto tipo Horario y lo BORRA en la
     * base de datos en la tabla horarios
     *
     * @param l
     * @return true=registra, false=presencia de error
     */
    ...
    /**
     * Metodo que BORRA TODOS los horarios en la base de datos
     *
     * @return true=registra, false=presencia de error
     */
    @Override
    ...
    /**
     * Metodo que recibe un id de Horario y retorna un Objeto de tipo
     * Horario, sino encuentra el horario el Objeto que retorna es nulo (null)
     *
     * @param id
     * @return Location
     */
    public Horario getHorario(int id) {
        ...
        if (isOkConexion()) {
            ...
            //Reutilizo metodo de horariosList con SQL en busqueda de horarios
            ...
            if (horariosList.size() == 1) {
                ...
                //hago una nueva instancia de h(Horario) con el valor de la posicion 0
                h = new Horario(hList.getId(), hList.getDescripcion(), hList.getOrden());
            }
        }
        //Retorno el valor del Objeto h
        return h;
    }
